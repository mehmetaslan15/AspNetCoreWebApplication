...
namespace AspNetCoreWebApplication.Areas.Admin.Controllers
{
    ...
    public class AppUsersController : Controller
    {
        ...
        public async Task<ActionResult> IndexAsync()  // async ifadesi bu metodun asenkron çalışacağını ifade eder. 
        {
        ...
        {
            return View();  // Eğer sayfa ilk açıldığında view a vir veri göndermemiz gerekirse bu blokta göndermeliyiz.
        }
