...
namespace AspNetCoreWebApplication.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        {
            return View(await _databaseContext.Products.Include(c => c.Category).Include(b => b.Brand).ToListAsync());  //Include komutuyla index sayfasında gözüken Category ve Brand sütunlarını doldurmuş olduk. 
        }
        ...
        {
            return View(await _databaseContext.Products.Include(c=> c.Category).Include(b => b.Brand).FirstOrDefaultAsync(p=> p.Id == id));
        }
